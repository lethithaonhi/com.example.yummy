...
public class RestaurantActivity extends AppCompatActivity {
    ...
    private String[] typeName ={getResources().getString(R.string.Exp), getResources().getString(R.string.hot), getResources().getString(R.string.nearby), getResources().getString(R.string.discount)
